...
const testimonials = [
  { quote: "BaelTrees helped us plant 10,000 trees as part of our carbon neutrality goal. Their execution was flawless.", name: "CSR Head", company: "Leading IT Company" },
  { quote: "Our employee volunteering partnership with BaelTrees has been the highlight of our CSR calendar for 3 years running.", name: "HR Director", company: "Global Manufacturing Firm" },
];
